...
#define TRDB_D5M_READ_MODE_1_REG_STROBE_START_FIRST_TRIGGER                               (0x0000)
#define TRDB_D5M_READ_MODE_1_REG_STROBE_START_START_OF_SIMULTANEOUS_EXPOSURE              (0x0004)
#define TRDB_D5M_READ_MODE_1_REG_STROBE_START_SHUTTER_WIDTH                               (0x0008)
#define TRDB_D5M_READ_MODE_1_REG_STROBE_START_SECOND_TRIGGER                              (0x000c)
